defmodule Comparator.ReviewsTest do
  use Comparator.DataCase
  ...
  describe "reviews" do
    ...
    test "update_review/2 with valid data updates the review" do
      ...
      assert review.recommended == false
